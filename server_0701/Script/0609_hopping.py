...
targetList = [[5.5,11],[5.5,5],[5.5,11],[5.5,5],[5.5,11],[5.5,5],[5.5,11],[5.5,5],[5.5,11],[5.5,5]]
fileNum = 0
...
def rotatingMotion(CT,currX,currY,shipHeading,diffAngle,targetCoor,deltaTime,updateGPS):
    ...
    if CT>=1780:
        ...
        while abs(diffAngle) > 50:
            ...
            #PostSimulator(deltaTime, currX, currY, targetCoor, aFromTarget, dFromTarget, shipHeading, updateGPS, LT,
            #              RT, CT, diffAngle)
...
def PostSimulator(deltaTime, currX, currY, targetCoor, aFromTarget, dFromTarget, shipHeading, updateGPS, LT,RT,CT,diffAngle):
    ...
    try:
        ...
        PostSimulator(deltaTime, currX, currY, targetCoor, aFromTarget, dFromTarget, shipHeading, updateGPS, LT,RT,CT,diffAngle)
...
def getHeading(updateGPS,currX,currY,gpsDataTime):
    ...
    print(':::::: Current Velocity',velocity,'[m/s] ::::::')
    if velocity >= 1.5:
